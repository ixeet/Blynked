...
public class Selectmsg extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selectmsg);
     ...
     // autoCompView.getBackground().setColorFilter(getResources().getColor(Color.parseColor("#FF11A3F1")), PorterDuff.Mode.SRC_ATOP);
     ...
     //   apkList.setOnItemClickListener(this);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
             ...
             */
                            ...
                            @Override
                            public void run() {
                                Intent i1 = new Intent(Selectmsg.this, Share_main.class);
             ...
             */
                            ...
                            @Override
                            public void run() {
                                Intent i1 = new Intent(Selectmsg.this, Share_main1.class);
                                // i1.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                                startActivity(i1);
                                finish();
                                // close this activity
                    ...
                    case 2:
                      ...
                      //  r11.setVisibility(View.INVISIBLE);
                        Intent i2 = new Intent(Selectmsg.this, Request_main.class);
                    ...
                    case 3:
                        ...
                        Intent i22 = new Intent(Selectmsg.this, Favourite_main.class);
                    ...
                    case 4:
                        //   RelativeLayout r1=(RelativeLayout)findViewById(R.id.r1);
                        Intent i222 = new Intent(Selectmsg.this, Calendar_main.class);
                        // i2.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        //  i2.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        startActivity(i222);
                        finish();
                        break;
                    case 5:
                        Intent ih = new Intent(Selectmsg.this, HistoryActivity.class);
                        startActivity(ih);
                        finish();
                        break;
                    case 6:
                        //   RelativeLayout r1=(RelativeLayout)findViewById(R.id.r1);
                       Intent ii = new Intent(Selectmsg.this, Setting_main.class);
                        startActivity(ii);
                        finish();
                        break;
                }
       ...
       /* ttt.setOnClickListener(new View.OnClickListener() {
        ...
        pass.setOnClickListener(new View.OnClickListener() {
             ...
             */
                        ...
                        @Override
                        public void run() {
                            Intent ii1 = new Intent(Selectmsg.this, Share_main.class);
                            //statusCheck();
                            startActivity(ii1);
                            finish();
                            // close this activity
