...
public class SqliteHelper2 extends SQLiteOpenHelper {
    ...
    public boolean saveUser (String id,int flag)
    {
        ...
        if (cursor.getCount() == 0) { // Record does not exist
            ...
            result = db.insert("ss", null, contentValues);
        } else { // Record exists
            result = db.update("ss", contentValues, "id=?", new String[] { id });
        }
    ...
    public void update(String id, int flag ) {
        ...
        args.put("flag", flag);
        db.update("ss", args, strFilter, null);
    }
    ...
    public ArrayList<HashMap<String, Object>> getAllUsers() {
        ...
        String selectQuery = "SELECT  * FROM ss";
