 ...
 */
public class Adapterrauto extends BaseAdapter implements Filterable {
    ...
    public Adapterrauto(Context context, ArrayList<DataModel1> countrylist) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        vi = inflater.inflate (R.layout.liststyleauto, parent,false);
