...
/**
 * Created by PIYANKA GUPTA on 8/15/2015.
 */
...
public class Contactsqlite extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sql = "CREATE TABLE cs " +
                "(id TEXT PRIMARY KEY,flag INTEGER)";
        db.execSQL(sql);
    ...
    public boolean saveUser (String id,int flag)
    {
        ...
        if (cursor.getCount() == 0) { // Record does not exist
            ...
            result = db.insert("cs", null, contentValues);
        } else { // Record exists
            result = db.update("cs", contentValues, "id=?", new String[] { id });
        }
    ...
    public void update(String id, int flag ) {
        ...
        args.put("flag", flag);
        db.update("cs", args, strFilter, null);
    }
    ...
    public ArrayList<HashMap<String, Object>> getAllUsers() {
        ...
        String selectQuery = "SELECT  * FROM cs";
